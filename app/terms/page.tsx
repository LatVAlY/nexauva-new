    ...
    <main className="min-h-screen pt-32 pb-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl font-light mb-8">Terms of Service</h1>
          <div className="prose prose-invert max-w-none">
            <p className="text-muted-foreground leading-relaxed mb-6">Last updated: January 2025</p>

            <h2 className="text-2xl font-medium mt-12 mb-4">Agreement to Terms</h2>
            <p className="text-muted-foreground leading-relaxed mb-6">
              By accessing or using our services, you agree to be bound by these Terms of Service and all applicable
              laws and regulations.
            </p>

            <h2 className="text-2xl font-medium mt-12 mb-4">Use of Services</h2>
            <p className="text-muted-foreground leading-relaxed mb-6">
              You may use our services only as permitted by law and these Terms. You must not misuse our services or
